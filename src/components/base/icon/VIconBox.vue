...
export type VIconBoxColor = 'primary' | 'info' | 'success' | 'warning' | 'danger' | 'purple' | 'yellow' | 'orange' | 'green' | 'red' | 'blue'
...
<template>
    <div
        class="v-icon"
        :class="[props.size && 'is-' + props.size, props.color && 'is-' + props.color, props.rounded && 'is-rounded', props.bordered && 'is-bordered']"
    >
        <slot></slot>
    </div>
</template>
