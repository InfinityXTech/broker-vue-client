...
<template>
    <small
        ...
        :class="[
            ...
            props.label && 'is-' + props.label.toString().toLowerCase()
        ]"
...
.is-dark {
    .tag {
        &:not(.is-primary):not(.is-secondary):not(.is-success):not(.is-info):not(.is-warning):not(.is-danger):not(.is-orange):not(.is-green):not(.is-blue):not(.is-purple):not(.is-black) {
