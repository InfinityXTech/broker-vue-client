...
export interface CallSendMessageButtonEmits {
    (e: 'send-message', value: any): void
}

// export interface ChatMessageFieldWrapperProps {
//     modelValue?: any
// }
// const props = withDefaults(defineProps<ChatMessageFieldWrapperProps>(), {
//     modelValue: '',
// })
...
const emit = defineEmits<CallSendMessageButtonEmits>()
...
const sendMessage = () => {
    if (modelValue.value == '') {
        ...
        emit('send-message', modelValue.value)
        modelValue.value = ''
    }
    return false
}
        ...
        <div class="control">
            ...
            <form @submit.prevent="sendMessage()">
                ...
                <div class="send-message">
                    <button class="button v-button is-primary is-raised is-rounded">Send</button>
                </div>
            </form>
        </div>
