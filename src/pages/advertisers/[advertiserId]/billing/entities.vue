...
import SchemeList from '/@src/schemes/advertisers/billing/entitiesList.json'
import SchemeEdit from '/@src/schemes/advertisers/billing/entitiesEdit.json'
import SchemeNew from '/@src/schemes/advertisers/billing/entitiesEdit.json'
...
//     viewWrapper.setPageTitle('Advertiser: ' + response?.data?.name + ' - Billing Entities')
// })
...
<template>
    <AdvertiserHeader :advertiser-id="props.advertiserId" title="Billing Entities"></AdvertiserHeader>
    <LocalToolbar>
        <CurrencyConverter />
    </LocalToolbar>
    ...
    <Datatable
        ...
        :uri="`/advertisers/${props.advertiserId}/billing/entities/all`"
        :custom="custom"
    ...
    <ApiForm
        ...
        :scheme="SchemeNew"
        store-method="post"
        :store-data="`/advertisers/${props.advertiserId}/billing/entities/create`"
    ...
    <ApiForm
        ...
        :fetch-data="`/advertisers/${props.advertiserId}/billing/entities/${update}`"
        :scheme="SchemeEdit"
        store-method="post"
        :store-data="`/advertisers/${props.advertiserId}/billing/entities/update/${update}`"
    ...
    <ApiForm
        ...
        store-method="delete"
        :store-data="`/advertisers/${props.advertiserId}/billing/entities/delete/${remove}`"
