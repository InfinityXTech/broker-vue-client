...
import SchemeAdvertiser from '/@src/schemes/marketing_billings/advertiserBalancesList.json'
    ...
    <div class="advertiser_balances">
        <div style="max-width: 300px">
            <ApiForm
                ...
                store-method="post"
                store-data="/marketing_billings/advertisers_balances"
                store-on="change"
        ...
        <VLoader :active="isLoading" size="large">
            <div v-if="!isLoading" class="columns is-multiline is-mobile">
                <div class="column inv-column" :class="['is-12-mobile', 'is-half-mobile', 'is-two-quarter-desktop']">
                    ...
                    <Datatable :columns="SchemeAdvertiser.columns" :model-value="datatable" :custom="custom" :download="true" :show-only-screen-data="false" />
                </div>
                <div class="column inv-column" :class="['is-12-mobile', 'is-half-mobile', 'is-two-quarter-desktop']">
                    <h1 class="title">Advertisers (minus)</h1>
                    <Datatable :columns="SchemeAdvertiser.columns" :model-value="datatable_minus" :custom="custom" :download="true" />
                </div>
                <div class="column inv-column" :class="['is-12-mobile', 'is-half-mobile', 'is-two-quarter-desktop']">
                    <h1 class="title">Advertisers (plus)</h1>
                    <Datatable :columns="SchemeAdvertiser.columns" :model-value="datatable_plus" :custom="custom" :download="true" />
                </div>
            </div>
