        ...
        <VLoader :active="isFetching" size="xl">
            <div class="block">
                <h2>
                    ...
                    <div v-if="is_access_edit && general.manual_status" class="manual-status" style="display: inline-block; width: 200px">
                        <Multiselect
            ...
            <div class="block settings-negative-balance">
                ...
                <ApiForm
                    ...
                    title="Set broker's settings negative balance"
                    :wrapper="VModal"
                    :gauth="true"
                    :readonly="!is_access_edit"
                ...
                <VButton
                    v-if="is_financial && is_access_edit && general.action_on_negative_balance == 'stop' && general.balance < 0"
