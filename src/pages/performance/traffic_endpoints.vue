...
import SchemeForm from '/@src/schemes/performance/endpointsForm.json'
import SchemeList from '/@src/schemes/performance/endpointsList.json'
...
<template>
    ...
    <ApiForm
        ...
        title="Traffic Endpoints Performance"
        :fetch-data="performance.data"
        :scheme="SchemeForm"
        store-method="post"
        store-data="/performance/traffic_endpoints"
        store-on="change"
