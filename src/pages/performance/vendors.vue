...
import SchemeForm from '/@src/schemes/performance/vendorsForm.json'
import SchemeList from '/@src/schemes/performance/vendorsList.json'
...
<template>
    ...
    <ApiForm
        ...
        title="API Vendors Performance"
        :fetch-data="performance.data"
        :scheme="SchemeForm"
        store-method="post"
        store-data="/performance/vendors"
        store-on="change"
    ...
    <div class="head-text">API Vendors</div>
